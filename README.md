...
It was noticed that in the c_4 prompt testing images, Amari seemed to display very pronounced clavicles. After looking at the 4 images within the c_4 training group, 3/4 of the images were found to have visible clavicles. Stable-Diffusion seems to have taken the concept of clavicles and amplified it to caricature-esque levels. Hinting that if a trained human model wanted to be created, a large number of images with varying clothes, facial expressions, lighting, etc. would need to be provided to counteract any possibility of the model latching onto any specific characteristic. That being said, the ideal number of images that would be needed is unknown. After reviewing the data produced by the 3 training groups—I'm led to believe that as little as 30-50 images could be enough to create a relatively realistic model of a person. More testing would need to be done to know for certain.
